...
public class CourseSystem {
    ...
    private static CourseSchedule createSchedule() {
        ...
        LocalTime startTime = LocalTime.of(11,35,00);
        LocalTime endTime  = LocalTime.of(12,55,00);

        CourseSchedule toReturn =  new CourseSchedule(Semester.getSemester(Semester.Term.Winter, 2022), pDayOfWeek,
                startTime, endTime);
        return toReturn;
    }
